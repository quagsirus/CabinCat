...
public partial class @GameInput: IInputActionCollection2, IDisposable
{
    ...
    ~@GameInput()
    {
        Debug.Assert(!m_freeroam.enabled, "This will cause a leak and performance issues, GameInput.freeroam.Disable() has not been called.");
        Debug.Assert(!m_telescope.enabled, "This will cause a leak and performance issues, GameInput.telescope.Disable() has not been called.");
        Debug.Assert(!m_memory.enabled, "This will cause a leak and performance issues, GameInput.memory.Disable() has not been called.");
        Debug.Assert(!m_pause.enabled, "This will cause a leak and performance issues, GameInput.pause.Disable() has not been called.");
        Debug.Assert(!m_cutscene.enabled, "This will cause a leak and performance issues, GameInput.cutscene.Disable() has not been called.");
    }
